      ...
      <form onSubmit={onSubmit} className="space-y-5">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div className="space-y-2">
            ...
            />
            {errors.name && <span className="text-[9px] text-red-500 font-bold ms-2 uppercase tracking-tighter">{errors.name.message}</span>}
          </div>
          <div className="space-y-2">
            <label className="flex items-center gap-2 text-[var(--text-muted)] text-[10px] font-black uppercase tracking-widest ms-1">
              <MdEmail /> Email
            ...
            />
            {errors.email && <span className="text-[9px] text-red-500 font-bold ms-2 uppercase tracking-tighter">{errors.email.message}</span>}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div className="space-y-2">
            ...
            />
            {errors.phone && <span className="text-[9px] text-red-500 font-bold ms-2 uppercase tracking-tighter">{errors.phone.message}</span>}
          </div>
          <div className="space-y-2">
            <label className="flex items-center gap-2 text-[var(--text-muted)] text-[10px] font-black uppercase tracking-widest ms-1">
              <MdLock /> Password
            ...
            />
            {errors.password && <span className="text-[9px] text-red-500 font-bold ms-2 uppercase tracking-tighter">{errors.password.message}</span>}
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          {errors.role && <span className="text-[9px] text-red-500 font-bold ms-2 uppercase tracking-tighter">{errors.role.message}</span>}
        </div>
