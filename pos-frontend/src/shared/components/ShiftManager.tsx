          ...
          <form onSubmit={openForm.onSubmit} className="space-y-8 relative z-10">
            <div className="group">
              ...
              {openForm.errors.openingBalance && (
                <span className="text-[10px] text-red-500 font-black mt-2 ms-2 block uppercase tracking-widest">{openForm.errors.openingBalance.message as string}</span>
              )}
            </div>
        ...
        <form onSubmit={closeForm.onSubmit} className="space-y-8">
           <div className="group">
              ...
              {closeForm.errors.closingBalance && (
                <span className="text-[10px] text-red-500 font-black mt-2 ms-2 block uppercase tracking-widest">{closeForm.errors.closingBalance.message as string}</span>
              )}
