...
import { getCustomers, addCustomer } from "@/shared/api/services/customerApi";
      ...
      <div className="mb-4 bg-[var(--bg-card-alt)] p-1 rounded-xl border border-[var(--border-main)] flex gap-1">
        {[
          ...
          <button
            ...
            className={`flex-1 py-2 text-[10px] font-black uppercase tracking-wider rounded-lg transition-all ${orderType === type.id
