                ...
                <div className="space-y-5">
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <span className={`inline-block px-2.5 py-0.5 rounded-full text-[8px] font-black uppercase tracking-wider border mb-1 ${selectedNode.type === "category" ? "bg-amber-500/10 border-amber-500/20 text-amber-500" :
