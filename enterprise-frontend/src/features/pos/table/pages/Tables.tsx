...
import { getTables } from "@/shared/api/services/tableApi";
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="flex items-center gap-3 mt-2">
                <button
                  ...
                  className={`text-[10px] font-bold px-3 py-1 rounded-full border transition-all ${serviceStatus === "all" ? "bg-[var(--primary)] text-black border-[var(--primary)]" : "text-[var(--text-muted)] border-[var(--border-main)] hover:border-[var(--text-muted)]"
                    }`}
                >
                ...
                <button
                  ...
                  className={`text-[10px] font-bold px-3 py-1 rounded-full border transition-all ${serviceStatus === "PREPARING" ? "bg-yellow-500/20 text-yellow-500 border-yellow-500/50" : "text-[var(--text-muted)] border-[var(--border-main)] hover:border-[var(--text-muted)]"
                    }`}
                >
                ...
                <button
                  ...
                  className={`text-[10px] font-bold px-3 py-1 rounded-full border transition-all ${serviceStatus === "READY" ? "bg-green-500/20 text-green-500 border-green-500/50" : "text-[var(--text-muted)] border-[var(--border-main)] hover:border-[var(--text-muted)]"
                    }`}
                >
