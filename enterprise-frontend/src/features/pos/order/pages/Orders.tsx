...
import { getOrders } from "@/shared/api/services/orderApi";
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs font-black uppercase tracking-widest transition-all border ${dateFilter === "today"
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs font-black uppercase tracking-widest transition-all border ${showOnlyMine
                  ? "bg-[var(--primary)] border-[var(--primary)] text-black"
                  : "bg-transparent border-[var(--border-main)] text-[var(--text-muted)] hover:border-[var(--primary)] hover:text-[var(--primary)]"
                }`}
            >
          ...
          <div className="flex items-center bg-[var(--bg-card)] p-1 rounded-xl border border-[var(--border-main)] overflow-x-auto whitespace-nowrap scrollbar-hide max-w-fit">
            {statusTabs.map((tab) => (
              <button
                ...
                className={`px-6 py-2 rounded-lg font-bold text-sm transition-all ${status === tab.id
